...
void TestFunctionalityHuge(
    ...
    SearchServer srv;
    {
        LOG_DURATION("UPDATE TIME")
        srv.UpdateDocumentBase(docs_input);
    }
    ostringstream queries_output;
    {
        LOG_DURATION("SEARCH TIME")
        srv.AddQueriesStream(queries_input, queries_output);
    }
...
void TestHuge() {
    ...
    {
        LOG_DURATION("TEST HUGE");
        TestFunctionalityHuge(docs, queries, expected);
    }
}
void TestUpdate() {
    const vector<string> docs = {
